...
export default function Projects() {
    ...
    return (<>
        ...
        <div className=' p-div-5'>
            <div className='p-div-5-inner'>
                <img src={require("./images/22.jpg")} className={"p-div-5-img "} />
                <h3 className='p-div-5-title'>title</h3>
            </div>
            <div className='p-div-5-inner'>
                <img src={require("./images/22.jpg")} className={"p-div-5-img "} />
                <h3 className='p-div-5-title'>title</h3>
            </div><div className='p-div-5-inner'>
                <img src={require("./images/22.jpg")} className={"p-div-5-img "} />
                <h3 className='p-div-5-title'>title</h3>
            </div><div className='p-div-5-inner'>
                <img src={require("./images/22.jpg")} className={"p-div-5-img "} />
