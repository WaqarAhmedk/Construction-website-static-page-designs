...
export default function Wahtwedo() {
    return (<>
        ...
        {/* 4th  */}
        <div className='wedo-div-4'>

            <div className='wedo-div-4-inner-1' >
                <ul className='wedo-div-4-ul'>
                    <li>
                        <span>
                            ALL SERVICES
                        </span>
                        <ChevronRight className='wedo-div-4-ul-icon'/>
                    </li>
                    <li>
                        <span>
                           CONSTRUCTION
                ...
                <h4 className='ms-3'>DOWNLOAD YOUR FILES</h4>
                <div className='wedo-div-4-down ms-3'>
                    <div>
                        {/* empty div forbackground color */}
                    </div>
                    <span className='ms-2'>DOWNLOAD FILE</span>
                    <ChevronDown className='ms-4'/>
                </div>
                <div className='wedo-div-4-down mt-3 ms-3'>
                    <div>
            ...
            <div className='wedo-div-4-inner'>
                <img src={require("./images/22.jpg")} className={"wedo-div-4-img "} />
                <h3 className='wedo-div-4-title'>CONSTRUCTIONS</h3>
                <p>
            ...
            <div className='wedo-div-4-inner'>
                <img src={require("./images/22.jpg")} className={"wedo-div-4-img "} />
                <h3 className='wedo-div-4-title'>RENOVATIONS</h3>
                <p>
                We offer varioty of construction types. From small jobs to big projects. Renovations, house construction, road construction, corporate and industrial work.
                </p>
                <span>READ MORE</span>
            ...
            <div className='wedo-div-4-inner'>
                <img src={require("./images/22.jpg")} className={"wedo-div-4-img "} />
                <h3 className='wedo-div-4-title'>BIG PROJECTS</h3>
                <p>
                We offer varioty of construction types. From small jobs to big projects. Renovations, house construction, road construction, corporate and industrial work.
                </p>
                <span>READ MORE</span>
            ...
            <div className='wedo-div-4-inner'>
                <img src={require("./images/22.jpg")} className={"wedo-div-4-img "} />
                <h3 className='wedo-div-4-title'>CONSULTING</h3>
                <p>
                We offer varioty of construction types. From small jobs to big projects. Renovations, house construction, road construction, corporate and industrial work.
                </p>
                <span>READ MORE</span>
            ...
            <div className='wedo-div-4-inner'>
                <img src={require("./images/22.jpg")} className={"wedo-div-4-img "} />
                <h3 className='wedo-div-4-title'>ARCHITECTURE</h3>
                <p>
                We offer varioty of construction types. From small jobs to big projects. Renovations, house construction, road construction, corporate and industrial work.
                </p>
                <span>READ MORE</span>
            ...
            <div className='wedo-div-4-inner'>
                <img src={require("./images/22.jpg")} className={"wedo-div-4-img "} />
                <h3 className='wedo-div-4-title'>CONCRETE TRANSPORT</h3>
                <p>
                We offer varioty of construction types. From small jobs to big projects. Renovations, house construction, road construction, corporate and industrial work.
                </p>
                <span>READ MORE</span>
